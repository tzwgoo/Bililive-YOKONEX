    ...
    if method in GIFT_METHODS:
        ...
        return _build_event(
            ...
            payload={
                ...
                "price": unit_price,
                "r_price": total_price,
                "log_id": _first_text(gift_message, "logId", "log_id"),
                "trace_id": _first_text(gift_message, "traceId", "trace_id"),
                "group_id": _first_int(gift_message, "groupId", "group_id"),
                "repeat_end": _first_int(gift_message, "repeatEnd", "repeat_end"),
                "send_time": _first_int(gift_message, "sendTime", "send_time"),
                "guard_level": 0,
                "guard_label": "",
            },
        )
